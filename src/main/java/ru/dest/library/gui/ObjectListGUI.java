...
import ru.dest.library.obj.IHoldItemStack;
...
public class ObjectListGUI<Object extends IHoldItemStack> extends GUI{
    ...
    protected final BiConsumer<InventoryClickEvent, Object> onItemClick;

    protected int page, pages;

    public ObjectListGUI(GUITemplate template, Player opener, List<Object> items, BiConsumer<InventoryClickEvent, Object> onItemClick) {
